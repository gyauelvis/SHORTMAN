...
from dictionary_words import dictionary_words, image_hash_table
...
class MainScreen(Screen):
    ...
    def search_word(self, instance):
        ...
        meaning = dictionary_words.get(word, None)
        image_filename = image_hash_table.get(word, None)
...
class AddWordScreen(Screen):
    ...
    def submit_word(self, instance):
        ...
        if word and meaning and image_path:
            ...
            image_hash_table[word] = image_path
...
class MeaningScreen(Screen):
    ...
    def delete_word(self, instance):
        ...
        if word in image_hash_table:
            del image_hash_table[word]
...
if __name__ == '__main__':
    DictionaryApp().run()from kivy.uix.label import Label
from kivy.uix.floatlayout import FloatLayout
from kivy.uix.screenmanager import ScreenManager, Screen
from kivymd.app import MDApp
from kivymd.uix.textfield import MDTextField
