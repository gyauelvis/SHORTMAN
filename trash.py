...
class CustomPopup(Popup):
    def __init__(self, **kwargs):
        ...
        self.size = (400, 200)
        self.auto_dismiss = False  # Prevent dismissing on touch outside

        # Customize the content of the pop-up screen
        self.content = Label(text='This is a custom pop-up screen.')
...
class MainScreen(Screen):
    def __init__(self, **kwargs):
        ...
        self.text_input.bind(focus=self.show_popup) 
        ...
        search_button = MDIconButton(
            icon="magnify",
            pos_hint={'right': 0.7, 'center_y': 0.5}
        )
        ...
        microphone_button = MDIconButton(
            icon="microphone",
            pos_hint={'right': 0.75, 'center_y': 0.5}
        )
